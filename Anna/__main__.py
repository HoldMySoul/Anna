...
from Anna import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Anna.modules import ALL_MODULES
from Anna.modules.helper_funcs.chat_status import is_user_admin
from Anna.modules.helper_funcs.misc import paginate_modules
...
Anna_IMG = "https://i.imgur.com/1oah5E2.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Anna.modules." +
                                              module_name)
