...
import Anna.modules.helper_funcs.git_api as api
import Anna.modules.sql.github_sql as sql

from Anna import dispatcher, OWNER_ID, EVENT_LOGS, DRAGONS, DEMONS
