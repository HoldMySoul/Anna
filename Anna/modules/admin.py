...
from Anna import DRAGONS, dispatcher
from Anna.modules.disable import DisableAbleCommandHandler
from Anna.modules.helper_funcs.chat_status import (bot_admin, can_pin,
                                                           can_promote,
                                                           connection_status,
                                                           user_admin,
                                                           ADMIN_CACHE)
...
INVITE_HANDLER = DisableAbleCommandHandler(["invitelink", "link"], invite)
