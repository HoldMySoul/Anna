...
import Anna.modules.sql.notes_sql as sql
from Anna import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Anna.__main__ import DATA_IMPORT
from Anna.modules.helper_funcs.chat_status import user_admin
from Anna.modules.helper_funcs.alternate import typing_action

# from Anna.modules.rules import get_rules
import Anna.modules.sql.rules_sql as rulessql

# from Anna.modules.sql import warns_sql as warnssql
import Anna.modules.sql.blacklist_sql as blacklistsql
from Anna.modules.sql import disable_sql as disabledsql

# from Anna.modules.sql import cust_filters_sql as filtersql
# import Anna.modules.sql.welcome_sql as welcsql
import Anna.modules.sql.locks_sql as locksql
from Anna.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @AnnaSupport"
            )
...
def export_data(update, context):
    ...
    f = open("Anna{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Anna{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Anna-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("Anna{}.backup".format(chat_id))  # Cleaning file
