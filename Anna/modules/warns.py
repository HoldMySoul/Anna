...
import telegram
from Anna import WOLVES, dispatcher
from Anna.modules.disable import DisableAbleCommandHandler
from Anna.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
...
from Anna.modules.helper_funcs.string_handling import split_quotes
from Anna.modules.log_channel import loggable
from Anna.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Anna's sticker
        keyboard = None
